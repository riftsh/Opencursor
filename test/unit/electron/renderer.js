...
async function loadTests(opts) {
	...
	const _allowedTestsWithOutput = new Set([
		...
		'issue #149412: VS Code hangs when bad semantic token data is received', // github.com/riftsh/opencursor/issues/192440
		'issue #134973: invalid semantic tokens should be handled better', // github.com/riftsh/opencursor/issues/192440
		'issue #148651: VSCode UI process can hang if a semantic token with negative values is returned by language service', // github.com/riftsh/opencursor/issues/192440
		'issue #149130: vscode freezes because of Bracket Pair Colorization', // github.com/riftsh/opencursor/issues/192440
		'property limits', // github.com/riftsh/opencursor/issues/192443
		'Error events', // github.com/riftsh/opencursor/issues/192443
