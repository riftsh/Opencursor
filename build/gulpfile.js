...
const compileClientTask = task.define('compile-client', task.series(compileApiProposalNamesTask, compileTask('src', 'out', false)));
...
const _compileFastTask = task.define('compile-fast', task.series(
	() => { process.env.FAST_BUILD = 'true'; return Promise.resolve(); },
	task.parallel(compileClientTask, compileExtensionsTask, compileExtensionMediaTask)
));
