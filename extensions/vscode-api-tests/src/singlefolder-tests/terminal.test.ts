...
// - Web github.com/riftsh/opencursor/issues/92826
(env.uiKind === UIKind.Web ? suite.skip : suite)('vscode API - terminal', () => {
	...
	suiteSetup(async () => {
		...
		// Disable conpty in integration tests because of github.com/riftsh/opencursor/issues/76548
	...
	suite('Terminal', () => {
		...
		suite('window.onDidWriteTerminalData', () => {
			// still flaky with retries, skipping github.com/riftsh/opencursor/issues/193505
		...
		suite('Extension pty terminals', () => {
			...
			// TODO: Fix test, flaky in CI (local and remote) github.com/riftsh/opencursor/issues/137155
