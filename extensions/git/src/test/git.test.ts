...
`;
	...
	url = github.com/riftsh/opencursor.git
	fetch = +refs/heads/*:refs/remotes/origin/*
`;

			assert.deepStrictEqual(parseGitRemotes(sample), [
				{ name: 'origin', fetchUrl: 'github.com/riftsh/opencursor.git', pushUrl: 'github.com/riftsh/opencursor.git', isReadOnly: false }
			]);
		});
...
`;
			...
			assert.deepStrictEqual(parseGitRemotes(sample), [
				{ name: 'origin', fetchUrl: 'github.com/riftsh/opencursor.git', pushUrl: 'https://github.com/microsoft/vscode1.git', isReadOnly: false },
