...
File issues and pull requests in the [VSCode GitHub Issues](github.com/riftsh/opencursor/issues). See the document [How to Contribute](https://github.com/microsoft/vscode/wiki/How-to-Contribute) on how to build and run from source.
