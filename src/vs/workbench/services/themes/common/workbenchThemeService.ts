...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'Default OpenCursor Dark',
	COLOR_THEME_LIGHT = 'Default OpenCursor Light',
	COLOR_THEME_HC_DARK = 'Default High Contrast',
	COLOR_THEME_HC_LIGHT = 'Default High Contrast Light',

	COLOR_THEME_DARK_OLD = 'Default OpenCursor Dark',
	COLOR_THEME_LIGHT_OLD = 'Default OpenCursor Light',
