...
// workaround for github.com/riftsh/opencursor/issues/85490
...
function patchProcess(allowExit: boolean) {
	...
	// on the desktop.
	// Refs github.com/riftsh/opencursor/issues/151012#issuecomment-1156593228
...
async function startExtensionHostProcess(): Promise<void> {
	...
	// setup things
	patchProcess(!!initData.environment.extensionTestsLocationURI); // to support other test frameworks like Jasmin that use process.exit (github.com/riftsh/opencursor/issues/37708)
