...
suite('Link protection domain matching', () => {
	...
	test('case normalization', () => {
		// github.com/riftsh/opencursor/issues/99294
		linkAllowedByRules('github.com/riftsh/opencursor/issues/new', ['https://github.com/microsoft']);
		linkAllowedByRules('github.com/riftsh/opencursor/issues/new', ['https://github.com/microsoft']);
	});

	test('ignore query & fragment - github.com/riftsh/opencursor/issues/156839', () => {
