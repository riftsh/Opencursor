	...
	private registerListeners(): void {
		...
		this.rawListeners.add(this.raw.onDidOutput(async event => {
			...
			if (event.body.variablesReference) {
				...
				// see github.com/riftsh/opencursor/issues/126967#issuecomment-874954269
		...
		this.rawListeners.add(this.raw.onDidInvalidated(async event => {
			...
			// If invalidated event only requires to update variables or watch, do that, otherwise refetch threads github.com/riftsh/opencursor/issues/106745
