...
export type ChatWorkflowPhase = 'planning' | 'execution' | 'reflection' | 'complete' | 'failed';

export interface IChatWorkflowPhaseProgress {
	kind: 'workflowPhase';
	phase: ChatWorkflowPhase;
	message?: string;
	attempt: number;
}

export interface IChatWorkflowStepProgress {
	kind: 'workflowStep';
	stepId: string;
	label: string;
...
export type IChatProgress =
	...
	| IChatWorkflowPhaseProgress
	| IChatWorkflowStepProgress
	| IChatTask
	| IChatTaskResult
	| IChatCommandButton
	| IChatWarningMessage
