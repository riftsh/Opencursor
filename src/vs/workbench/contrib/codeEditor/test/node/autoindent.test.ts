...
suite('Auto-Reindentation - TypeScript/JavaScript', () => {
	...
	test('Issue #25437', () => {
		// issue: github.com/riftsh/opencursor/issues/25437
	...
	test('Issue #86176', () => {
		// issue: github.com/riftsh/opencursor/issues/86176
	...
	test('Issue #141816', () => {
		...
		// issue: github.com/riftsh/opencursor/issues/141816
	...
	test('Issue #29886', () => {
		// issue: github.com/riftsh/opencursor/issues/29886
	...
	test.skip('Issue #56275', () => {
		...
		// issue: github.com/riftsh/opencursor/issues/56275
		// explanation: If */ was not before the }, the regex does not allow characters before the }, so there would not be an indent
		// Here since there is */ before the }, the regex allows all the characters before, hence there is a deindent
	...
	test.skip('Issue #116843', () => {
		...
		// issue: github.com/riftsh/opencursor/issues/116843
		// related: github.com/riftsh/opencursor/issues/43244
	...
	test.skip('Issue #185252', () => {
		...
		// issue: github.com/riftsh/opencursor/issues/185252
	...
	test.skip('Issue 43244: incorrect indentation when signature of function call spans several lines', () => {
		...
		// issue: github.com/riftsh/opencursor/issues/43244
