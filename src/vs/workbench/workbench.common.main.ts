...
registerSingleton(IViewDescriptorService, OpenCursorViewDescriptorService, InstantiationType.Delayed);
...
import { OpenCursorViewDescriptorService } from './services/views/opencursor/opencursorViews.js';
