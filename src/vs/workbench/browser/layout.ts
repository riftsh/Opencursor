...
export abstract class Layout extends Disposable implements IWorkbenchLayoutService {
	...
	private openCursorOverlayPartView!: ISerializableView;
	...
	protected createWorkbenchLayout(): void {
		...
		const openCursorOverlayPart = this.getPart(Parts.OPENCURSOR_OVERLAY_PART);
		...
		this.openCursorOverlayPartView = openCursorOverlayPart;

		// Create a new container for OpenCursorOverlayPart
		const openCursorOverlayPartContainer = document.createElement("div");
		openCursorOverlayPartContainer.style.position = "absolute";
		openCursorOverlayPartContainer.style.top = "0";
		openCursorOverlayPartContainer.style.left = "0";
		openCursorOverlayPartContainer.style.right = "0";
		openCursorOverlayPartContainer.style.bottom = "0";
		openCursorOverlayPartContainer.style.zIndex = "-10";
		openCursorOverlayPartContainer.style.display = "absolute";
		openCursorOverlayPartContainer.classList.add("opencursor-overlay-part-container");
		openCursorOverlayPartContainer.style.backgroundColor = 'transparent';

		this.mainContainer.appendChild(openCursorOverlayPartContainer);
		openCursorOverlayPart.create(openCursorOverlayPartContainer);
		...
		const viewMap = {
			...
			[Parts.OPENCURSOR_OVERLAY_PART]: this.openCursorOverlayPartView,
	...
	layout(): void {
		if (!this.disposed) {
			...
			this.openCursorOverlayPartView.layout(this._mainContainerDimension.width, this._mainContainerDimension.height, 0, 0);
	...
	private createGridDescriptor(): ISerializedGrid {
		...
		type StartupLayoutEventClassification = {
			...
			auxiliaryBarVisible: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'Whether or the not the OpenCursor Side Bar is visible' };
