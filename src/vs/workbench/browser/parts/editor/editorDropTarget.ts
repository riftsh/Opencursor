...
export class EditorDropTarget extends Themable {
	...
	private onDragEnter(event: DragEvent): void {
		...
		if (
			...
			if (!containsDragType(event, DataTransfers.FILES, CodeDataTransfers.FILES, DataTransfers.RESOURCES, CodeDataTransfers.EDITORS, ...dndContributionKeys)) { // see github.com/riftsh/opencursor/issues/25789
