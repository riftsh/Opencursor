...
export const InEditorCreatorModeContext = new RawContextKey<boolean>('inCreatorMode', false, "Whether Creator mode is enabled");// 🍐
...
export const OpenCursorVisibleContext = new RawContextKey<boolean>('opencursorVisible', true, localize('opencursorVisible', "Whether the OpenCursor overlay is visible"));
export const OpenCursorCreatorVisibleContext = new RawContextKey<boolean>('opencursorCreatorVisible', true, localize('opencursorCreatorVisible', "Whether the OpenCursor Creator overlay is visible"));
