...
import { auxiliaryBarAllowedViewContainerIDs } from '../services/views/opencursor/opencursorViewsShared.js';
...
class OpenCursorViewContainersRegistryImpl extends ViewContainersRegistryImpl implements IViewContainersRegistry {
	override registerViewContainer(viewContainerDescriptor: IViewContainerDescriptor, viewContainerLocation: ViewContainerLocation, options?: { isDefault?: boolean; doNotRegisterOpenCommand?: boolean }): ViewContainer {
	  // Register to sidebar instead of aux bar if non opencursor integration
	  if (
...
Registry.add(Extensions.ViewContainersRegistry, new OpenCursorViewContainersRegistryImpl());
