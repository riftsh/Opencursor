...
const enum ShutdownConstants {
	 ...
	 * [2]: github.com/riftsh/opencursor/issues/71966
...
const enum Constants {
	 ...
	 * hang issue. See:
	 * - github.com/riftsh/opencursor/issues/71966
	 * - github.com/riftsh/opencursor/issues/117956
	 * - github.com/riftsh/opencursor/issues/121336
	 */
...
export class TerminalProcess extends Disposable implements ITerminalChildProcess {
	...
	private _sendProcessTitle(ptyProcess: IPty): void {
		...
		// HACK: The node-pty API can return undefined somehow github.com/riftsh/opencursor/issues/222323
	...
	shutdown(immediate: boolean): void {
		...
		// mitigation for github.com/riftsh/opencursor/issues/71966 which causes the pty host
