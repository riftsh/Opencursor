...
suite('Config Remotes', () => {
	...
	test('HTTPS remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('github.com/riftsh/opencursor.git'), allowedDomains), ['github.com']);
	...
	test('Multiple remotes', function () {
		const config = ['github.com/riftsh/opencursor.git', 'https://git.example.com/gitproject.git'].map(remote).join('');
	...
	test('Non allowed domains are anonymized', () => {
		const config = ['github.com/riftsh/opencursor.git', 'https://git.foobar.com/gitproject.git'].map(remote).join('');
	...
	test('HTTPS remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('github.com/riftsh/opencursor.git')), ['github.com/microsoft/vscode.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('github.com/riftsh/opencursor.git'), true), ['github.com/microsoft/vscode']);
		...
		assert.deepStrictEqual(getRemotes(remote('github.com/riftsh/opencursor.git'), true), getRemotes(remote('https://github.com/microsoft/vscode')));
