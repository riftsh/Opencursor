...
export class ProtocolMainService extends Disposable implements IProtocolMainService {
	...
	private readonly validExtensions = new Set(['.svg', '.png', '.jpg', '.jpeg', '.gif', '.bmp', '.webp', '.mp4', '.otf', '.ttf']); // github.com/riftsh/opencursor/issues/119384
	...
	constructor(
		...
		// - storage    : all files in global and workspace storage (github.com/riftsh/opencursor/issues/116735)
