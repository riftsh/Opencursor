...
export class View extends ViewEventHandler {
	...
	constructor(
		...
		// Set role 'code' for better screen reader support github.com/riftsh/opencursor/issues/93438
	...
	private _scheduleRender(): void {
		...
		if (this._renderAnimationFrame === null) {
			// TODO: workaround fix for github.com/riftsh/opencursor/issues/229825
