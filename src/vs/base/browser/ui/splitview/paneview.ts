...
export abstract class Pane extends Disposable implements IView {
	...
	render(): void {
		...
		// Use role button so the aria-expanded state gets read github.com/riftsh/opencursor/issues/95996
...
class PaneDraggable extends Disposable {
	...
	private dragOverCounter = 0; // see github.com/riftsh/opencursor/issues/14470
