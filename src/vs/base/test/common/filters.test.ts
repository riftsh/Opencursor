...
suite('Filters', () => {
	...
	test('PrefixFilter - ignore case', function () {
		...
		filterNotOk(matchesPrefix, 'T', '4'); // see github.com/riftsh/opencursor/issues/22401
	});
	...
	test('Freeze when fjfj -> jfjf, github.com/riftsh/opencursor/issues/91807', function () {
		assertMatches(
			'jfjfj',
	...
	test('configurable full match boost', function () {
		...
		// also works with wordStart > 0 (github.com/riftsh/opencursor/issues/187921)
