...
export abstract class VSCodeTestRunner {
	...
	public async debug(testRun: vscode.TestRun, baseArgs: ReadonlyArray<string>, filter?: ReadonlyArray<vscode.TestItem>) {
		...
		const args = [
			...
			// for breakpoint freeze: github.com/riftsh/opencursor/issues/122225#issuecomment-885377304
			'--js-flags="--regexp_interpret_all"',
			// for general runtime freezes: github.com/riftsh/opencursor/issues/127861#issuecomment-904144910
